...
C       COMPUTE THETA FROM 1950
        THETAC = DMOD(1.7294446614D0 + 1.72027915246D-2*NDAY +
...
C
        ...
        IDS70 = TS70
        TFRAC = TS70 - IDS70
        THETAC = DMOD(1.73213438565D0 + 1.720279169407D-2*IDS70 +
     *               (1.720279169407D-2+TWOPI)*TFRAC +
     *               5.0755141943D-15*TS70**2, TWOPI)
      ENDIF
      IF (THETAC.LT.0.D0) THETAC = THETAC + TWOPI
      RETURN
